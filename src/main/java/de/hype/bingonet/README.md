...
Because the packaging matters this has to be done in a seperate package or the package at the top of the File wouldn't match possibly in
Future Projects.
...
- /environment This may be used by Shared. This is for a shared package name with different Code. This should only be used if there is
  really no other way to do it in shared!
