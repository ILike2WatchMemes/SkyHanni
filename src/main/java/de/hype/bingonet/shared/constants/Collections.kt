...
interface Collections {
    ...
    enum class Farming(
        ...
        Cocoa_Beans("INK_SACK:3", "COCOA_GENERATOR_1", 4.0, 3.0,1.0, 75, 200, 500, 2_000, 5_000, 10_000, 20_000, 50_000, 100_000),
        Carrot("CARROT_ITEM", "CARROT_GENERATOR_1", 4.0, 3.0,3.5, 100, 250, 500, 1_750, 5_000, 10_000, 25_000, 50_000, 100_000),
        Cactus("CACTUS", "CACTUS_GENERATOR_1", 4.0, 2.0,1.5, 100, 250, 500, 1_000, 2_500, 5_000, 10_000, 25_000, 50_000),
        Raw_Chicken("RAW_CHICKEN", "CHICKEN_GENERATOR_1", baseXp = 0.1, baseCropOnBroken = 1.0, copperCropMultiplier = 1.0,50, 100, 250, 1_000, 2_500, 5_000, 10_000, 25_000, 50_000, 100_000),
        Sugar_Cane(
            "SUGAR_CANE",
        ...
        Raw_Rabbit("RABBIT", "RABBIT_GENERATOR_1", baseXp = 0.1, baseCropOnBroken = 1.0, copperCropMultiplier = 1.0,50, 100, 250, 1_000, 2_500, 5_000, 10_000, 25_000, 50_000),
        Nether_Wart(
            "NETHER_STALK",
        ...
        Mutton("MUTTON", "SHEEP_GENERATOR_1", baseXp = 0.1, baseCropOnBroken = 1.0, copperCropMultiplier = 1.0,50, 100, 250, 1_000, 2_500, 5_000, 10_000, 25_000, 50_000, 100_000),
        Melon("MELON", "MELON_GENERATOR_1", 4.0, 5.0,4.0, 250, 500, 1_250, 5_000, 15_000, 25_000, 50_000, 100_000, 250_000),
        Potato("POTATO_ITEM", "POTATO_GENERATOR_1", 4.0, 3.0,3.0, 100, 200, 500, 1_750, 5_000, 10_000, 25_000, 50_000, 100_000),
        Leather("LEATHER", "COW_GENERATOR_1", baseXp = 0.1, baseCropOnBroken = 1.0, copperCropMultiplier = 1.0,50, 100, 250, 500, 1_000, 2_500, 5_000, 10_000, 25_000, 50_000, 100_000),
        Raw_Porkchop("PORK", "PIG_GENERATOR_1", baseXp = 0.1, baseCropOnBroken = 1.0, copperCropMultiplier = 1.0,50, 100, 250, 1_000, 2_500, 5_000, 10_000, 25_000, 50_000),
        Feather("FEATHER", "CHICKEN_GENERATOR_1", baseXp = 0.1, baseCropOnBroken = 1.0, copperCropMultiplier = 1.0,50, 100, 250, 1_000, 2_500, 5_000, 10_000, 25_000, 50_000),
        ;
    ...
    enum class Mining(override val id: String, override val minionID: String?, vararg tiers: Int) : Collections {
        ...
        End_Stone("ENDER_STONE", "ENDER_STONE_GENERATOR_1", 50, 100, 250, 1_000, 2_500, 5_000, 10_000, 15_000, 25_000, 50_000),
        ...
        Obsidian("OBSIDIAN", "OBSIDIAN_GENERATOR_1", 50, 100, 250, 1_000, 2_500, 5_000, 10_000, 25_000, 50_000, 100_000),
        ...
        Mithril("MITHRIL_ORE", "MITHRIL_GENERATOR_1", 50, 250, 1_000, 2_500, 5_000, 10_000, 250_000, 500_000, 1_000_000),
    ...
    enum class Combat(override val id: String, override val minionID: String?, vararg tiers: Int) : Collections {
        Ender_Pearl("ENDER_PEARL", "ENDERMAN_GENERATOR_1", 50, 250, 1_000, 2_500, 5_000, 10_000, 15_000, 25_000, 50_000),
        ...
        Rotten_Flesh("ROTTEN_FLESH", "ZOMBIE_GENERATOR_1", 50, 100, 250, 1_000, 2_500, 5_000, 10_000, 25_000, 50_000, 100_000),
    ...
    enum class Fishing(override val id: String, override val minionID: String?, vararg tiers: Int) : Collections {
        ...
        Raw_Fish("RAW_FISH", "FISHING_GENERATOR_1", 20, 50, 100, 250, 500, 1_000, 2_500, 15_000, 30_000, 45_000, 60_000),
        ...
        Magmafish("MAGMA_FISH", null, 20, 100, 500, 1_000, 5_000, 15_000, 30_000, 50_000, 75_000, 100_000, 250_000, 500_000),
