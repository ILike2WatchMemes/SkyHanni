...
class ChChestConfig {
    @Expose
    @ConfigOption(name = "Show All Valuable Findings", desc = "When enabled it will show you a Chat Prompt when any Valuable Item is found.")
    @ConfigEditorBoolean
    ...
    @Expose
    @ConfigOption(name = "Show Electron Transmitter", desc = "When enabled it will show you a Chat Prompt when an Electron Transmitter is found.")
    @ConfigEditorBoolean
    ...
    @Expose
    @ConfigOption(name = "Show Robotron Reflector", desc = "When enabled it will show you a Chat Prompt when a Robotron Reflector is found.")
    @ConfigEditorBoolean
    ...
    @Expose
    @ConfigOption(name = "Show 5k+ Gemstone Powder", desc = "When enabled it will show you a Chat Prompt when a LOT of Gemstone Powder is found.")
    @ConfigEditorBoolean
    var gemstonePowder: Boolean = false
    @Expose
    @ConfigOption(name = "Show 5k+ Mithril Powder", desc = "When enabled it will show you a Chat Prompt when a LOT of Mithril Powder is found.")
    @ConfigEditorBoolean
    var mithrilPowder: Boolean = false

    val chChestChatPromp= KeyBind()
}
